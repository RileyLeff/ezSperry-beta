...
weib_df = data.frame(rowname = c("weibull_b", "weibull_c", "pct_resist_at_ksat"),
...
# PLANT 
#####
setClass("Plant", representation(plant_kmax = "numeric", 
                                 height = "numeric", la_to_ba = "numeric", leaf_width = "numeric", avg_p_rhizo_r = "numeric", 
                                 root_aspect_r = "numeric", root_beta = "numeric"), prototype(plant_kmax = 415.66, height = 8.78, la_to_ba = 977.8, leaf_width = .04096, avg_p_rhizo_r = 50, root_aspect_r = 1,
                                                                                              root_beta = .98))

##### 
# STAND 
#####
setClass("Stand", representation(latitude = "numeric", longitude = "numeric", 
                                 ...
                                 solar_noon_corr = "numeric", ba_to_ga = "numeric"), prototype(latitude = 40.79, 
...
# ATMOSPHERE
#####
setClass("Atmosphere", representation(sky_emiss = "numeric", atm_trans = "numeric", 
                                      o2_mol_frac = "numeric"), prototype(sky_emiss = .97, atm_trans = .69,
                                                                          o2_mol_frac = .21))

#####
# PHOTOSYNTHESIS
#####
setClass("Photosynthesis", representation(atm_co2_pa = "numeric", atm_co2_ppm = "numeric", quantum_yield_e_t = "numeric", 
                                          ...
                                          ha_jmax = "numeric", hd_jmax = "numeric", sv_jmax = "numeric"), prototype(atm_co2_pa = 28.173, atm_co2_ppm = 354.8, 
...
setClass("Options", representation(gw_p = "numeric", gw_d = "numeric", gw = "logical", 
                                   soil_redist = "logical", soil_evap = "logical", refilling = "logical", rain = "logical", use_gs_data = "logical", weibin_mode = "logical", alex_mode = "logical", depth_override = "logical", radius_override = "logical", soil_verbose = "logical", tag = "character", id = "numeric"), prototype(gw_p = 0, 
                                                                                                                                                                                                                                            gw_d = 1, gw = FALSE, soil_redist = FALSE, soil_evap = FALSE, refilling = FALSE, rain = FALSE, use_gs_data = FALSE, weibin_mode = FALSE, alex_mode = FALSE, depth_override = FALSE ,radius_override = FALSE, soil_verbose = FALSE, tag = NA_character_, id = NA_real_))
